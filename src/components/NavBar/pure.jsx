  ...
  if (props.loggedIn)
    return (
      <div id="nav__bar" className="flex--row flex--between flex--align-center">
        <div>
          <Link to="/">Search</Link>
          <Link to="/user/orders/created">Orders</Link>
          <Link to="/user/orders/attending">Attending Orders</Link>
        ...
        <div className="flex--row flex--between">
          ...
          <div className="nav__ddown" onClick={handleDropdown}>
            ...
            <div className="nav__ddown-list">
              ...
              <Link
                className="nav__ddown-li nav__li--danger"
                to="#"
                onClick={e => {
                  e.preventDefault();
                  props.logout();
