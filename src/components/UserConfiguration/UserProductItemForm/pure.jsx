  ...
  return (
    <div className="card fade-in no--padding">
      <div id="product-form" className="grid-12 col-gap-15 card--no-bg">
        ...
        <div className="button" disabled={formDisabled} onClick={submit}>
          {formIsUpdating ? "Update" : "Create"}
        </div>
        {formIsUpdating && (
          <div
      ...
      {formDisabled && <div className="progress-bar" />}
    </div>
  );
};
