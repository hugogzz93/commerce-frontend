...
export const queryUserProductFailAction = createAction(
  "USER_PRODUCT/FETCH/FAIL"
);
export const updateUserProductStoreAction = createAction(
  "STORE/USER_PRODUCT/UPDATE"
);
export const cartUpdateFailAction = createAction(
  "USER_PRODUCT/RELATIONS/CART/FAIL"
);
...
export const userProductReducer = createReducer(
  {
    [updateUserProductStoreAction]: (state, payload) => ({
      ...state,
      ...payload.map(uProduct => ({ [uProduct.id]: uProduct }))
    })
  },
  InitialState
);
